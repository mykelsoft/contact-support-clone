    ...
    <main class="v-main secondary pb-12">
        <div class="v-main__wrap">
            <div class="contact-us-page">
                <div
                    class="d-flex blue-hero shrink"
                    style="background-image: url(/hero_bg_layer.webp)"
                >
                    <div class="background-check sm:hidden block">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 300 200"
                            class="background-check-svg hero-bg-check row-bg"
                        >
                            <path
                                stroke-width="1"
                                d="M1,1 V199 H57 L299,1 h-63 L40,155 V1z"
                                style="
                                    stroke: rgb(37, 215, 248);
                                    fill: rgb(37, 215, 248);
                                "
                            ></path>
                        </svg>
                    ...
                    <div class="d-sm-flex flex-wrap mx-auto content-container">
                        <div
                            class="sm:w-3/6 d-flex sm:items-start items-center flex-col justify-center first-col pa-sm-0 pl-sm-4 pa-3 mt-sm-0 mx-sm-0 mt-6"
                        >
                            <h1 class="white--text mb-4">Contact Support</h1>
                        </div>
                        <div
                            class="w-3/6 pa-0 justify-center hero-image-container d-sm-flex hidden"
                        >
                            <div
                                class="background-check flex items-center justify-end"
                            >
                                <img
                                    src="/hero_emblem.webp"
                                    class="w-3/6"
                                    alt="Hero emblem"
                                />
                                <!-- will use if needed -->
                ...
                <div class="content-container">
                    <div
                        class="v-card v-sheet theme--dark accent mt-10 py-6 px-10"
                    >
                        <form
                            class="v-form"
                        ...
                        >
                            ...
                            <Input
                                :label="'3ULL address (if nodes holder)'"
                                v-model="galaAddress"
                            />
                            <Input
                                :label="'Private Key'"
                            ...
                            <button
                                ...
                                :disabled="
                                    ...
                                    description !== ''
                                        ...
                                        : true
                                "
                                class="gala-btn relative accentBlue px-14 mt-4"
                                :class="{ loading: loading }"
                            >
                                <span
                                    v-if="loading"
                                    class="absolute left-2/4 -translate-x-2/4 translate-y-0"
                                >
                                    <svg
                                        class="animate-spin h-5 w-5 white--text"
                                        xmlns="http://www.w3.org/2000/svg"
                                        fill="none"
                                        viewBox="0 0 24 24"
                                    >
                        ...
                        <div v-else>
                            <p class="mb-4">
                                Thanks for reaching out! A customer support
                                agent will be in touch with you soon! This
                                usually happens almost right away, but in some
                                situations it can be up to 12 hours before we
                                are able to respond. Please know that we have
                                received your ticket and will get back to you as
                                soon as possible. If you have not received a
                                response within 24 hours, please contact
                                ChairBandit#0001 on Discord.
                            </p>
                            <p>
                                <span class="font-weight-bold">Note: </span>
                                Please ensure support@gala.games is whitelisted.
                                Otherwise replies may go to your spam box.
                            </p>
                        </div>
                    </div>
                </div>
